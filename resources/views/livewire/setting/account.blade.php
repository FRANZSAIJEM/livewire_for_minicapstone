                        ...
                        {{-- <div class="float-start">
                            ...
                            <div class="image-upload position-relative">
                                ...
                                <label for="image" class="upload-label d-flex align-items-center justify-content-center">
                                    <img width="275" height="275" src="{{ $image ? $image->temporaryUrl() : (auth()->user()->image ? asset('uploads/image_uploads/' . auth()->user()->image) : asset('default_images/blank-profile.jpg')) }}" alt="Profile Image" class="preview-image rounded-circle bg-dark">
                                </label>
                            </div>
                            <h4 class="text-dark p-3 w-100 rounded mt-4 text-center">{{auth()->user()->name}}</h4>
                            @endif
                        </div> --}}
